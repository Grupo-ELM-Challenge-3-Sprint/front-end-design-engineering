                    ...
                    <div className="max-w-[800px] mx-auto border border-gray-200 rounded-lg overflow-hidden md:text-[18px]">
                        {faqs.map((faq, indice) => (
                            <div className="border-b border-gray-200" key={indice}>
                                <button className="faq-question text-[#1a237e] cursor-pointer text-[1.05em] p-5 w-full text-left flex justify-between items-center font-semibold hover:bg-[#eff1f7] focus:bg-[#eff1f7] focus:outline-none duration-200" type="button" aria-expanded={openIndex === indice} aria-controls={`faq-answer-${indice}`}
