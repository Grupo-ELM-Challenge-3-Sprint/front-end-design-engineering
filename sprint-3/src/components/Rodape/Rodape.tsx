export default function Rodape() {
  return (
    <footer>
        {/* <div classNameName="container footer-content">
            <div classNameName="footer-column about">
                <h3>SimplesHC</h3>
            ...
            <div classNameName="footer-column links">
                <h4>Navegação</h4>
                <ul>
            ...
            <div classNameName="footer-column contact">
                <h4>Contato</h4>
